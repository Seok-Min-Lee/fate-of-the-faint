...
using System.IO;
using UnityEngine;
public static class RunSaveDataIO
{
    // 파일명은 마음대로 바꿔도 됨
...
#endif
    public static void SaveToFile(RunSaveData data, string filePath = null)
    {
        if (data == null)
        {
    ...
    public static bool TryLoadFromFile(out RunSaveData data, string filePath = null)
    {
        filePath ??= DefaultFilePath;
