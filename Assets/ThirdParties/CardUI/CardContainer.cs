...
public class CardContainer : MonoBehaviour
{
    ...
    //    return playAreaCorners[0].x < cursorPosition.x && cursorPosition.x < playAreaCorners[2].x &&
    //           playAreaCorners[0].y < cursorPosition.y && cursorPosition.y < playAreaCorners[2].y;
    //}
